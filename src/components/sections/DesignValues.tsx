    ...
    <section className="pt-[120px] pb-[100px]">
      <div className="max-w-[1100px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[var(--card-gap)]">
          {values.map((v, i) => (
            <ScrollReveal key={v.titleKey} delay={0.2 + i * 0.12} className="h-full">
              <div className="glass-medium rounded-[var(--card-border-radius)] p-[36px_28px] h-full relative overflow-hidden transition-all duration-[400ms] ease-[var(--ease-out-expo)] hover:bg-[var(--color-bg-tertiary)] hover:border-[rgba(0,229,208,0.2)] hover:-translate-y-1 group">
